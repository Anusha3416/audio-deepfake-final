...
import { Mic, ShieldAlert, ShieldCheck, Activity } from "lucide-react";
...
export const Hero = () => {
  ...
  const sendAudio = async (blob) => {
    try {
      ...
      const data = await predictAudio(blob);
      ...
      console.error(e);
      alert(e.message || "Failed to analyze audio. Is the backend running?");
    } finally {
      setLoading(false);
    }
  };
